...
export default function AcceptInvite() {
    ...
    const processUrlCode = async () => {
      try {
        ...
        setCurrentUser({
          ...
          avatar:
            (isUser1Me ? u1.profileImageUrl : u2.profileImageUrl) ||
            "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png",
        });
        ...
        setPartnerUser({
          ...
          avatar:
            (isUser1Me ? u2.profileImageUrl : u1.profileImageUrl) ||
            "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png",
        });
  ...
  }, [code, navigate, storedUser.id, storedUser]);
  ...
  const handleAccept = async (e) => {
    ...
    if (!validateFormat(inviteCode)) {
      setError(
        "Formato inválido. O código deve ter exatamente 5 caracteres após o prefixo (ex: DUO-A1B2C).",
      );
      return;
    }
          ...
          <div className="w-full max-w-2xl text-center animate-fade-in flex flex-col items-center">
            ...
            <div className="animate-fade-in mt-4">
              ...
              <p className="text-gray-300 text-base mb-10">
                Você e {partnerUser.name} agora formam um Duo.
              </p>
              <div className="w-10 h-10 border-4 border-fuchsia-500 border-t-transparent rounded-full animate-spin mx-auto opacity-75"></div>
            </div>
          </div>
        )}
      </main>
